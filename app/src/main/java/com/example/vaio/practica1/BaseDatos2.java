...
public class BaseDatos2 extends AppCompatActivity {
    protected SQLiteDatabase db;
    protected Button btInsertar, btEliminar, btActualitzar, btConsultar;
    protected EditText eNombre, eTipo, eID, eMarca, ePrecio;
    protected TextView registro;
    protected String nombre,textReg;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_base_datos2);
        ...
        btActualitzar = (Button) findViewById(R.id.btActualitzar);
        ...
        btActualitzar.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                update(v);
            }
